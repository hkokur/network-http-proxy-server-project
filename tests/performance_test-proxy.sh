...
URL="http://127.0.0.1:8888/9997"  # Ensure the URI is /19999
DURATION="5s"
THREADS=(1 2 4 8 16 32)  # Number of threads to test
CONNECTIONS=($(seq 20 20 200))  # Number of connections to test

# Output log file
OUTPUT_FILE="../test_outputs/wrk_test_results_proxy.log"
...
if [ ! -s "$OUTPUT_FILE" ]; then
  echo "Performance Test Results (Proxy Server)" >> "$OUTPUT_FILE"
  echo "======================================" >> "$OUTPUT_FILE"
fi
